   ...
   <body>
      ...
      <div id="mapButtons">
        ...
        <button id="btnC" class="map-btn">검색</button>
  ...
  font-size:12px;
   ...
   <script>
         ...
         btnC.addEventListener("click", () => {
           document.getElementById("btnALLON").click();   // ✅ 전체 레이어 켜기
           searchPanel.style.display = "block";           // ✅ 검색창 열기
         });
         ...
         document.getElementById("doSearch").addEventListener("click", () => {
            ...
            // ✅ 여러 레이어 한꺼번에 모으기
            const targetLayers = [
              buildingLayer, gyoryangLayer, tunnelLayer, 
              riverLayer, sudoLayer, wallLayer, samyunLayer
            ];
            ...
            // ✅ 클릭하면 해당 위치로 이동
            resultBox.querySelectorAll("li").forEach((li, i) => {
              li.addEventListener("click", () => {
                const feature = matched[i];
                let center;
