	...
	<div class="card">
	  ...
	  <div style="flex:1; color:#555;">
	    <ul>
	      <li><b>위험도 산출 방법</b><br>
	          위험도 = 객체수 X 영향도</li>
	      <li><b>영향도</b> : 해당 피해가 건물에 끼치는 영향도에 따라 A~E등급으로 분류</li>
	      <li><b>영향도별 객체당 점수 측정</b> : 영향도A(10점), B(8점), C(6점), D(4점), E(2점)</li>
	      <li><b>객체수</b> : 건물에 존재하는 해당 피해수 (단위: 개)</li>
	      <li><b>위험도</b> : 영향도와 객체수에 비례하여 건물에 끼치는 피해량을 객관적인 수치로 나타내기 위한 지표</li>
	      <li><b>위험도 등급 기준</b> : A(400점~), B(300점~399점), C(200점~299점), D(100점~199점), E(0점~99점)</li>
	      <li><b>시설물 분류</b> : 교량, 터널, 하천, 상하수도, 옹벽, 절토사면, 건축물</li>
	      <li><b>피해 분류</b> : 균열, 누전, 누수, 변형, 구조이상</li>
	      <li><b>지역 분류</b> : 서울특별시 - 은평구, 서대문구, 종로구, 마포구, 영등포구, 서초구, 강남구, 구로구, 금천구</li>
	    </ul>
	  </div>
	</div>
